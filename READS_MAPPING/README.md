...
```./runSnakemakeWorkflow.sh --workflow ReadsMapping --workflow-path /home/jogirodolle/save/CAPTURE_PIPELINES_SNAKEMAKE --config-file CONFIG/config_ReadsMapping.yml --cluster-config CONFIG/cluster_config_ReadsMapping_Slurm.yml --jobs 20 --job-scheduler SLURM```  
