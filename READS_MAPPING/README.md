...
| Mapping_PairedEndFastqs     | Mapping the input fastq files onto the reference (paired end reads)                                                                 | bwa mem // bwa-mem2 mem // bowtie2 // minimap2; samtools view; samtools fixmate;                                                       |
