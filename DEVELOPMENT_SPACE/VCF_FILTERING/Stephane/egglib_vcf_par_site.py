...
header = """##INFO=<ID=SNP,Number=0,Type=Flag,Description="Variant with at least 2 mononucleotide alleles">
##INFO=<ID=INDEL,Number=0,Type=Flag,Description="Variant with at least 2 alleles of different lengths">
