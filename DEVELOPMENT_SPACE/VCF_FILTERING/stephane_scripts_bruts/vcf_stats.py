...
bedf = 'blast_BAITS_sur_zavitan_WEWSeq_v.2.0_20220420_all1_nident40_pos300_order_regroup_samtools.txt'
vcff = 'variants_calling_c_ordered.vcf'
lblf = 'labels_groups.txt'
...
outfile1 = 'stats.txt'
outfile2 = 'stats_pairwise.txt'
outfile3 = 'outliers.txt'

import egglib

vcf = egglib.io.VcfParser(vcff)
