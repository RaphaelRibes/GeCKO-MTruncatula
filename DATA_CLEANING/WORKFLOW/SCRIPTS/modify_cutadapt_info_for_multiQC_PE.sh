...
sed 's/\.R2/_trimmed\.R1/g' $info | awk -v T=$R1_tot -v W=$R1_written '{if ($1=="Total" && $2 == "basepairs") $4=T ; if ($1=="Total" && $2 == "written") $4=W ; print $0}' > $info_R1
sed 's/\.R2/_trimmed\.R2/g' $info | awk -v T=$R2_tot -v W=$R2_written '{if ($1=="Total" && $2 == "basepairs") $4=T ; if ($1=="Total" && $2 == "written") $4=W ; print $0}' > $info_R2
