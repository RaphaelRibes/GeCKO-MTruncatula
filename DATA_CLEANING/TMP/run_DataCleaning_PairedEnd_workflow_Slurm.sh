...
## RUN WITH CONDA ##
snakemake --snakefile ${PRGR}/DataCleaning_PairedEnd.smk --cluster-config ${CONFIG}/cluster_config_Slurm.json --configfile ${CONFIG}/config_file_PairedEnd.yml --jobs 200 --printshellcmds --use-conda --profile ${PROFILE}/SLURM
