...
```../../../runGeCKO.sh --workflow VcfFiltering --workflow-path ../../../../GeCKO --config-file CONFIG/config_VcfFiltering.yml --cluster-config CONFIG/cluster_config_VcfFiltering.yml --jobs 20 --job-scheduler SLURM```  
